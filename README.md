...
1. [Research and Selection of Methods](#1-research-and-selection-of-methods)  
   1.1 [Project Objectives and Goals](#11-project-objectives-and-goals)  
   1.2 [GitHub Repository Structure](#12-github-repository-structure)  
   1.3 [Literature Review](#13-literature-review)  
   &nbsp;&nbsp;&nbsp;&nbsp;1.3.1 [Predicting Buy/Hold/Sell Signals Using News Sentiment (Goal 1)](#131-predicting-buyholdsell-signals-using-news-sentiment-goal-1)  
   &nbsp;&nbsp;&nbsp;&nbsp;1.3.2 [Recommending Stocks Based on Investor Profiles (Goal 2)](#132-recommending-stocks-based-on-investor-profiles-goal-2)  
   &nbsp;&nbsp;&nbsp;&nbsp;1.3.3 [Building an NLP-Based Trading Bot (Goal 3)](#133-building-an-nlp-based-trading-bot-goal-3)  
   1.4 [Benchmarking](#14-benchmarking)  
   1.5 [Preliminary Experiments](#15-preliminary-experiments)  
   &nbsp;&nbsp;&nbsp;&nbsp;1.5.1 [Objectives](#151-objectives)  
   &nbsp;&nbsp;&nbsp;&nbsp;1.5.2 [Models and Techniques Tested](#152-models-and-techniques-tested)  
   &nbsp;&nbsp;&nbsp;&nbsp;1.5.3 [Preprocessing](#153-preprocessing)  
   &nbsp;&nbsp;&nbsp;&nbsp;1.5.4 [Key Findings](#154-key-findings)  
   &nbsp;&nbsp;&nbsp;&nbsp;1.5.5 [Conclusion](#155-conclusion)

2. [Model Implementation](#2-model-implementation)  
   2.1 [Framework Selection](#21-framework-selection)  
   2.2 [Dataset Preparation](#22-dataset-preparation)  
   &nbsp;&nbsp;&nbsp;&nbsp;2.2.1 [Data Loading and Integration](#221-data-loading-and-integration)  
   &nbsp;&nbsp;&nbsp;&nbsp;2.2.2 [Text Normalization and Tokenization](#222-text-normalization-and-tokenization)  
   &nbsp;&nbsp;&nbsp;&nbsp;2.2.3 [Sentiment Labeling](#223-sentiment-labeling)  
   &nbsp;&nbsp;&nbsp;&nbsp;2.2.4 [Feature Engineering](#224-feature-engineering)  
   &nbsp;&nbsp;&nbsp;&nbsp;2.2.5 [Label and Feature Encoding](#225-label-and-feature-encoding)  
   &nbsp;&nbsp;&nbsp;&nbsp;2.2.6 [Final Dataset Structure](#226-final-dataset-structure)  
   2.3 [Model Development](#23-model-development)  
   &nbsp;&nbsp;&nbsp;&nbsp;2.3.1 [Goal 1: Predict Buy / Hold / Sell (Classification)](#231-goal-1-predict-buy--hold--sell-classification)  
   &nbsp;&nbsp;&nbsp;&nbsp;2.3.2 [Goal 2: Recommend Stocks Based on Investor Profile](#232-goal-2-recommend-stocks-based-on-investor-profile)  
   &nbsp;&nbsp;&nbsp;&nbsp;2.3.3 [Goal 3: NLP-Based Trading Bot](#233-goal-3-nlp-based-trading-bot)  
   2.4 [Training and Fine-Tuning](#24-training-and-fine-tuning)  
   &nbsp;&nbsp;&nbsp;&nbsp;2.4.1 [Traditional Machine Learning Models](#241-traditional-machine-learning-models)  
   &nbsp;&nbsp;&nbsp;&nbsp;2.4.2 [Deep Learning Models](#242-deep-learning-models)  
   &nbsp;&nbsp;&nbsp;&nbsp;2.4.3 [Recommendation Models](#243-recommendation-models)  
   2.5 [Evaluation and Metrics](#25-evaluation-and-metrics)  
   &nbsp;&nbsp;&nbsp;&nbsp;2.5.1 [Classification Models](#251-classification-models)  
   &nbsp;&nbsp;&nbsp;&nbsp;2.5.2 [Recommendation Models](#252-recommendation-models)  
   &nbsp;&nbsp;&nbsp;&nbsp;2.5.3 [Trading Bot Models](#253-trading-bot-models)

3. [References (APA Style)](#3-references-apa-style)
